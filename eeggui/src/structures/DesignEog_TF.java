 ...
 * @author PHilt
 */
public class DesignEog_TF extends JMatlabStructWrapper{
    ...
    {
        which_extrema_curve         = getStringCellMatrix3D(struct, "which_extrema_curve");
    ...
    public MLStructure getJMatData()
    {
        ...
        struct.setField("which_extrema_curve",setStringTripleColumnCell(which_extrema_curve));
