...
project.do_source_analysis=1;                       % A6:  
...
project.study.associated_factors(1) = struct('filename', project.epoching.condition_names{1}, 'f1_level', 'centered'    , 'f2_level', 'walker');
project.study.associated_factors(2) = struct('filename', project.epoching.condition_names{2}, 'f1_level', 'translating' , 'f2_level', 'walker');
project.study.associated_factors(3) = struct('filename', project.epoching.condition_names{3}, 'f1_level', 'centered'    , 'f2_level', 'scrambled');
project.study.associated_factors(4) = struct('filename', project.epoching.condition_names{4}, 'f1_level', 'translating' , 'f2_level', 'scrambled');
...
project.stats.erp.num_permutations              = 2;           % number of permutations applied in ERP statistical analysis
...
project.postprocess.erp.roi_names={'eye', 'C12z'};

project.postprocess.erp.numroi=length(project.postprocess.erp.roi_list);

project.postprocess.erp.design(1).group_time_windows(1)=struct('name','N2','min',380, 'max',480, 'ref_roi', 'C12z');
...
project.postprocess.erp.design(1).deflection_polarity_list = {  ... design x roi x time_windows
                                ...   tw1      tw2  ...
                                {'negative';'negative'} ... roi1
                                {'negative';'negative'} ... roi2
};
...
% project.test3D = {     .... design x roi x freq band x time window
%                                     {... roi
...
project.results_display.erp.single_subjects='on';                          % display patterns of the single subjcts (keeping the average pattern)
...
project.results_display.erp.compact_display_xlim=[400 450];
