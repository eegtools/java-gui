...
while is_paused == 0
    ...
    [nx, ny, textbounds] = DrawFormattedText(mainwnd, txt_start_iti, 'center', 800, white, 55 , [], [], 1.5);
    Screen('Flip',mainwnd);        
    ...
    if (keyIsDown && can_pause == 1)
        ...
        if keyCode(p_key)
            ...
            [nx, ny, textbounds] = DrawFormattedText(mainwnd, txt_pause, 'center', 800, white, 55 ,[],[],1.5);
            Screen('Flip', mainwnd);               
