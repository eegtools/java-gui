...
N_TRIALS                = N_TRIALS_X_COND * N_COND;             ... 24 * 3 = 72
MIN_TRIAL_X_BLOCK       = N_COND * N_STIM_TYPE;                 ... 3 * 6 = 18;
    
MAX_BLOCK               = N_TRIALS / MIN_TRIAL_X_BLOCK;         ... 72 / 18 = 4      N_TRIALS_X_COND * N_COND /  N_COND * N_STIM_TYPE = N_TRIALS_X_COND / N_STIM_TYPE
NREP_STIM_TYPE_X_COND   = N_TRIALS_X_COND / N_STIM_TYPE;        ... 24 / 6 = 4

% DEFINE N_BLOCK in ORDER TO:
N_BLOCK                 = 4;                                    
N_TRIALS_X_COND_BLOCK   = N_TRIALS_X_COND / N_BLOCK;            ... 24 / 4 = 6
N_TRIALS_X_BLOCK        = N_TRIALS_X_COND * N_COND / N_BLOCK;   ... 24 * 3 / 4 = 18
