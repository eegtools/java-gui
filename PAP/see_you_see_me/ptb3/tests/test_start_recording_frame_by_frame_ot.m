...
% ==================================================================================================
dropped_frames=0;
pts=zeros(1, webcam_settings.fps*video_lenght);
num_pts=1;
elapsed1=0;
tex=0;
% ==================================================================================================
try
    ...
    tex=0;
    % display frames and create video
    start_time1=GetSecs;
    ...elapsed2=0;...start_time2=GetSecs;
    while 1
        num_pts=num_pts+1;        
        ...
        [tex, pts, df] = update_recording_webcam_screen_addframe(webcamscreens.wcs(record_cam), 'prev_tex', tex, 'rotation', 90);
    ...
    disp(['elapsed time: ' num2str(elapsed1)]);
