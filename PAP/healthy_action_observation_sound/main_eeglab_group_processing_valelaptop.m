...
... EXECUTION
group_list={{'AC_12_fabio_emg','AC_01_alice_emg', 'AC_02_chiara_emg','AC_04_dan_emg', 'AC_10_cristina_emg_sw','AC_11_claudio_emg','AC_13_emmanuel_emg','AC_14_andrea_emg', 'AC_15_alessandra_emg'}};
epochs_path=emg_epochs_path;  
list_sel_designs=[1 2];
...
do_eeglab_study_export_erp_r=1;
