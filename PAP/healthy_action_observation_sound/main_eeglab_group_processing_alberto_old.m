...
%subjects_list={'AC_01_alice', 'AC_02_chiara','AC_04_dan','AC_08_marco','AC_14_andrea'}; ... for debugging
...
%            {'CC_01_vittoria', 'CC_02_fabio', 'CC_03_anna'}};
%=====================================================================================================================================================================
% ======= OPERATIONS LIST ============================================================================================================================================
%=====================================================================================================================================================================
do_study=0;
...
%===================================================================================================================================================================
if do_study
    eeglab_study_create(project_settings,protocol_name, condition_names, group_list, pre_epoching_input_file_name, epochs_path);
end

if do_design
    eeglab_study_define_design(project_settings,fullfile(epochs_path, [protocol_name, '.study']), within_design_list, between_design_list);
end
...
if do_study_compute_channels_measures   
    ...
    for design_num=1:tot_des
        eeglab_study_compute_channels_measures(project_settings,fullfile(epochs_path, [protocol_name, '.study']), design_num, timeout_analysis_interval, freqout_analysis_interval, 'ALL', 'on', baseline_analysis_interval);
    end
end
...
if do_study_plot_roi_erp_curve_tw
    ...
    for design_num=1:length(sel_designs) 
        ...
        mkdir(plot_dir);        
        eeglab_study_plot_roi_erp_curve(project_settings,fullfile(epochs_path, [protocol_name, '.study']), sel_des,roi_list,roi_names,  time_windows_list{sel_des}, time_windows_names{sel_des},study_ls,num_permutations,correction,[],200,plot_dir,paired_list{sel_des},stat_method,display_only_significant); 
    end
end
...
if do_study_plot_erp_topo_tw
    ...
    for design_num=1:length(sel_designs) 
        ...
        mkdir(plot_dir);
        eeglab_study_plot_erp_topo_tw(project_settings,fullfile(epochs_path, [protocol_name, '.study']), sel_des, time_windows_list{sel_des},time_windows_names{sel_des},study_ls,num_permutations,correction,[-3,3],plot_dir,paired_list{sel_des},stat_method,display_only_significant);
    end
end
...
%         mkdir(plot_dir);
%         eeglab_study_plot_roi_erp2(project_settings,fullfile(epochs_path, [protocol_name, '.study']), list_sel_designs(sel_designs(design_num)),roi_list,roi_names,  [], [],study_ls,num_permutations,correction,[],200,plot_dir,paired_list{design_num},stat_method)
%     end
% end
% 
% 
...
%         mkdir(plot_dir);
%         eeglab_study_plot_erp_topo(project_settings,fullfile(epochs_path, [protocol_name, '.study']), list_sel_designs(sel_designs(design_num)), time_windows_list,time_windows_names,study_ls,num_permutations,correction,[-3,3],plot_dir,paired_list{design_num},stat_method);
%     end
% end
% 
% 
...
%         mkdir(plot_dir);
%         eeglab_study_plot_roi_tf(project_settings,fullfile(epochs_path, [protocol_name, '.study']), list_sel_designs(sel_designs(design_num)),roi_list,roi_names,study_ls,num_permutations,correction,[-3,3],[min(timeout_analysis_interval),max(timeout_analysis_interval)],[min(freqout_analysis_interval),max(freqout_analysis_interval)],1,2,[],[],[120],plot_dir,paired_list{design_num},stat_method);
%     end                           
% end
% 
...
%         mkdir(plot_dir);
%         eeglab_study_plot_tf_topo(project_settings,fullfile(epochs_path, [protocol_name, '.study']), list_sel_designs(sel_designs(design_num)), time_windows_list,time_windows_names,frequency_bands_list,frequency_bands_names,study_ls,num_permutations,correction,[-3,3],plot_dir,paired_list{design_num},stat_method);
%         close all
%     end
% end
