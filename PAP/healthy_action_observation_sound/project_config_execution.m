...
epo_end=1.95;% epochs start latency


bc_st=-950;% baseline correction start latency
bc_end=-50;% baseline correction end latency
...
import_marker={'DFDR' 'NFDR'};
% conditions: marker codes & name
valid_marker={'DFDR' 'NFDR'};


% conditions: marker codes & name

mrkcode_cond={'DFDR' 'NFDR'};
...
...condition_names={'DFDR' 'NFDR'}; 
condition_names={'DFDRsw' 'NFDR'}; ... 'DFDRsw'}; ...{'execution'};
...name_cond=condition_names;
...
within_design_names={'DvsND' 'mean'  }; ...{'execution'};...
