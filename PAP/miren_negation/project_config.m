...
original_data_suffix='_segm'; ... or also empty

do_source_analysis=0;
do_emg_analysis=0;
do_cluster_analysis=0;
do_emg_analysis=0;
...
...roi_names={'c3 cz c4','fc1 fc5','fc2 fc6','f8 fc6 c4','f7 fc5 c3','cp5 cp1','cp6 cp2','cp5 cp1 p3','cp6 cp2 p4','o1 oz o2','p3 pz p4'};
%roi_names={'F7', 'FC5', 'CP5', 'F8', 'FC6', 'CP6', 'c3 cz c4','f8 fc6','f7 fc5','O1 Oz O2'};
roi_names={'F8','CP6'};
...
%                     {[0 1400];[0 700];[700 1400]};...
%                     {[0 1400];[0 700];[700 1400]}...
                       {[0 100];[100 400];[400 1000];[1000 1400]};... 
                       {[0 100];[100 400];[400 1000];[1000 1400]};...
                       {[0 100];[100 400];[400 1000];[1000 1400]};...
           };
...
% p-values
study_ls=0.01;%0.00156;%0.005;%0.005;%NaN%
...
compact_display_xlim=[0 1200]; 
compact_display_ylim=[-3 2]; 
