...
if  strncmp(os,'Linux',2)
    ...
    ...local_projects_data_path='C:\Documents and Settings\danli\Desktop\EEG_shrare\DATA'; %what is this for?
        local_projects_data_path='\\geo\repository\groups\behaviour_lab\Projects\EEG_tools';
    eegtools_svn_local_path='C:\Documents and Settings\danli\Desktop\EEG_Tools';
    plugins_path='C:\Program Files\MATLAB\R2011a\toolbox';
end
...
conf_file_name='project_structure_90hz';
%=====================================================================================================================================================================
%=====================================================================================================================================================================
...
...project.subjects.list={'01_RV','02_CN','03_MA', '04_ML','05_MU','06_MC','07_ER','08_EC','09_AP','10_EA','11_GP','12_MA','13_LG','14_ER'}; project.subjects.numsubj=length(project.subjects.list); ... for debugging ,'07_ER','08_EC','09_AP','10_EA','11_GP','12_MA','13_LG','14_ER'
project.subjects.list={'07_ER','11_GP','12_MA','13_LG','14_ER'};project.subjects.numsubj=length(project.subjects.list); ... ,'10_EA','11_GP','12_MA','13_LG','14_ER'}; project.subjects.numsubj=length(project.subjects.list); ... for debugging ,'07_ER','08_EC','09_AP','10_EA','11_GP','12_MA','13_LG','14_ER'
...
if do_patch_triggers
    for subj=1:project.subjects.numsubj
        subj_name=project.subjects.list{subj}; 
        file_name1=fullfile(project.paths.epochs, [project.import.original_data_prefix subj_name pre_epoching_input_file_name '.set']);
        file_name2=fullfile(project.paths.epochs, [project.import.original_data_prefix subj_name  '.mat']);
        ...
        %   3)  add a "new event" at around X ms with respect to an "original  event"
        
        
        ...for ev=1:length(project.epoching.valid_marker)
            ...eeglab_subject_events_add_event_around_another_event(file_name, project.epoching.valid_marker{ev}, project.task.events.pause_end_trigger_value, tHand(1,i));
        ...end        
        ...
        ...EEG =  eeglab_subject_add_eve_on_eve1_nlags_from_eve2(file_name, input_file_name, list_class_eve1, list_class_eve2, max_delay,code_new_eve,suffix,nlag)
