...
[DOT,BARD,BAR,CROSS] = create_stimuli_struct(screen_param,protocol_param,pointing_data_normalized);
...
save([protocol_param.trialdir '\all\stimuli.mat'], 'DOT', 'BARD', 'BAR', 'CROSS');
