function [dot,bar,bard,barda,cross] = create_stimuli_struct(screen_param,protocol_param,pointing_data_normalized)
...
% USER DATA FIELD %
%%%%%%%%%%%%%%%%%%%
barda.bar.yposition = screen_param.H/2;
barda.dot.xposition = screen_param.W/2;  % X position in pixel
barda.dot.yposition = screen_param.H/2;  % Y position in pixel between [Ymin - Ymax]
%%%%%%%%%%%%%%%%%%
% COMPUTED FIELD %
%%%%%%%%%%%%%%%%%%
barda.bar.xstart = 0;
...
barda.bar.dim = 15; % Line Dimension
barda.bar.duration = 'wait';
barda.bar.color = screen_param.color.gray;
...
oval.w.coord = [-oval.w.radius -oval.w.radius oval.w.radius oval.w.radius]';
oval.b.coord = [-oval.b.radius -oval.b.radius oval.b.radius oval.b.radius]';
barda.dot.duration = 1; 
barda.dot.mtx_coord = [oval.w.coord  oval.b.coord] +  repmat([barda.dot.xposition;barda.dot.yposition;barda.dot.xposition;barda.dot.yposition],1,2);
barda.stimulustype = 'barda';
