...
% proprietà dello stimolo, è divisa per tipologia di stimoli CROSS DOT DOT2
...
try
    ...
    switch case_flag
        ...
        case 'bard'
            ...
            Screen('FillOval', window, [screen_param.color.blue' screen_param.color.black'],BARD.dot.mtx_coord);  
            err = 0;
