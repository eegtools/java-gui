...
% possible simpler design with only the centered condtions (see literature)
 STUDY = std_makedesign(STUDY, ALLEEG, 1, 'variable1','condition','variable2','','name','STUDY.design2cond','pairing1','on','pairing2','on','delfiles','off','defaultdesign','off','values1',{'cwalker' 'cscrambled'});
