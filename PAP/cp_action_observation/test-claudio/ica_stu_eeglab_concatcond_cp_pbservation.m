...
%==========================================================================
% PROJECT DATA
project_name='cp_action_observation';
subjects_list={'03_vale-Deci'};
analysis_name='raw_ica';
%==========================================================================
%==========================================================================
...
epochs_path=fullfile('G:\groups\behaviour_lab\Projects\EEG_tools\cp_action_observation\epochs');
...
% considering motion and shape factors
 STUDY = std_makedesign(STUDY, ALLEEG, 1, 'variable1','condition','variable2','','name','STUDY.design4cond','pairing1','on','pairing2','on','delfiles','off','defaultdesign','off','values1',{'control' 'AO' 'AOCS' 'AOIS'});
