...
cross_trigger_value=1;
question_trigger_value=6;
AOCS_trigger_value=7;
...
%     putvalue(dio,cross_trigger_value);
    ...
    switch iter
        ...
        case 1
            ...
            showMovieSendStartTrigger(file_video, window, dio, (iter+1));
        ...
        case 3
            ...
            showMovieSendDoubleTrigger(file_video, window, dio, (iter+1), sound_frame, AOCS_trigger_value);    % also send the frame at which send the second trigger
        ...
        case 4
            ...
            showMovieSendDoubleTrigger(file_video, window, dio, (iter+1), sound_frame, AOIS_trigger_value);    % also send the frame at which send the second trigger
