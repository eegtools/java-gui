...
while 0
    ...
    showMovieSendStartTrigger_cla_2(file_video, win, dio, control_trigger_value,test,trigger_duration);
%     if ~ test
...
%     end
    ...
    showMovieSendStartTrigger_cla_2(file_video, win, dio, AO_trigger_value,test,trigger_duration);
...
%     end
    ...
    showMovieSendDoubleTrigger_cla_2(file_video, win, dio, AOCS_trigger_value, sound_frame, AOCS_sound_trigger_value,test,trigger_duration);    % also send the frame at which send the second trigger
...
%     
    ...
    showMovieSendDoubleTrigger_cla_2(file_video, win, dio, AOCS_trigger_value, sound_frame, AOIS_sound_trigger_value,test,trigger_duration);    % also send the frame at which send the second trigger
...
% 8 -> 64: audio start in AOIS
        ...
        case 4
            ...
            showMovieSendDoubleTrigger_cla_2(file_video, win, dio, AOIS_trigger_value, sound_frame, AOIS_sound_trigger_value,test,trigger_duration);    % also send the frame at which send the second trigger
