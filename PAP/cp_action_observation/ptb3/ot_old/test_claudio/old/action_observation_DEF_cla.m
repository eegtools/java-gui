...
while 0
    ...
    showMovieSendStartTrigger_cla(file_video, window, dio, control_trigger_value,test);
    if ~ test
    ...
    showMovieSendStartTrigger_cla(file_video, window, dio, AO_trigger_value,test);
    ...
    showMovieSendDoubleTrigger_cla(file_video, window, dio, AOCS_trigger_value, sound_frame, AOCS_sound_trigger_value,test);    % also send the frame at which send the second trigger
    ...
    showMovieSendDoubleTrigger_cla(file_video, window, dio, AOCS_trigger_value, sound_frame, AOIS_sound_trigger_value,test);    % also send the frame at which send the second trigger
...
% 8 -> 64: audio start in AOIS
        ...
        case 4
            ...
            showMovieSendDoubleTrigger_cla(file_video, window, dio, AOIS_trigger_value, sound_frame, AOIS_sound_trigger_value,test);    % also send the frame at which send the second trigger
