...
while 0
    ...
    showMovieSendDoubleTrigger_cla_2(file_video, file_audio,win, dio, AOCS_trigger_value, audio_frame, AOCS_audio_trigger_value,test,trigger_duration);    % also send the frame at which send the second trigger
    ...
    showMovieSendDoubleTrigger_cla_2(file_video, file_audio, win, dio, AOS_trigger_value, audio_frame, AOIS_audio_trigger_value,test,trigger_duration);    % also send the frame at which send the second trigger
...
% 8 -> 64: audio start in AOIS
        ...
        case 3
            ...
            audio_frame=str2double(audio_onsets_frame_list{1,aocs_trial});
            showMovieSendDoubleTrigger_cla_2(file_video, win, dio, AOCS_trigger_value, audio_frame, AOCS_audio_trigger_value,test,trigger_duration);    % also send the frame at which send the second trigger
        ...
        case 4
            ...
            audio_frame=str2double(audio_onsets_frame_list{2,aois_trial});            
            showMovieSendDoubleTrigger_cla_2(file_video, win, dio, AOIS_trigger_value, audio_frame, AOIS_audio_trigger_value,test,trigger_duration);    % also send the frame at which send the second trigger
