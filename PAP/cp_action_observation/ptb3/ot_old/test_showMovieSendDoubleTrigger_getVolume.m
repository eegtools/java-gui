...
function test_showMovieSendDoubleTrigger_getVolume(moviename, win, port, first_trigger_value, second_trigger_frame, second_trigger_value, pahandle)
...
% Open movie file:
movie = Screen('OpenMovie', win, moviename,0,1,2);
...
%           disp(['frame ' num2str(frame_counter)]); 
    ...
    % Update display:
     [nx ny textbounds] = DrawFormattedText(win,['volume level:' ],'center', 0, [255 255 255], 55 ,[],[],1.5);
    Screen('Flip', win);
