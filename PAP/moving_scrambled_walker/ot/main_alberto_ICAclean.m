...
protocol_name='moving_scrambled_walker_cleanica';       ... must correspond to brainstorm db name 
...
analysis_name='OCICA_250_cleanica';                  ... subfolder containing the current analysis type (refers to EEG device input data type)
%==================================================================================
% ======= SOURCES PARAMS ==========================================================
...
do_process_stats_sources=0;           process_result_string='wmne.mat';     % substring used to get and process specific results file
