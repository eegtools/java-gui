...
local_projects_data_path='G:\behaviour_lab\Projects\EEG_tools\';
svn_local_path='D:\Users\Claudio\Desktop\IIT\behaviourPlatform\EEG_Tools';
plugins_path='D:\Users\Claudio\Matlab-Work\toolbox';
%==================================================================================
%==================================================================================
...
process_result_string='wmne_s3000.mat';     % substring used to get and process specific results file
...
%=====================================================================================================================================================================
%=====================================================================================================================================================================
addpath(genpath(svn_local_path));
define_paths  
%add these 2 lines if you don't want eeglab and brainstorm permanently in
%your matlab path
addpath(eeglab_path);
...
if do_check_bem
    ...
    src_file=fullfile(brainstorm_data_path, subj1_name,'@default_study', 'headmodel_surf_openmeeg.mat');

    for nsubj=2:numsubj
        dest_file=fullfile(brainstorm_data_path, subjects_list{nsubj},'@default_study', 'headmodel_surf_openmeeg.mat');
...
%         % 4 basic conditions
%         for cond=1:length(name_cond)
%             brainstorm_subject_sources_tf_timewnd_freqbands(protocol_name, sources_results{nsubj,cond},brainstorm_analysis_times, brainstorm_analysis_bands);
%         end
%         % main effects
%         for mcond=1:length(name_maineffects)
%             totcond=mcond+length(name_cond);
%             brainstorm_subject_sources_tf_timewnd_freqbands(protocol_name, sources_results{nsubj,totcond},brainstorm_analysis_times, brainstorm_analysis_bands);
%         end        
%     end    
end
...
if do_group_analysis
     results{1} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'cwalker','cscrambled',sources_norm,1,subjects_list);
     results{2} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'twalker','tscrambled',sources_norm,1,subjects_list);
     results{3} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'cwalker','twalker',sources_norm,1,subjects_list);
     results{4} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'cscrambled','tscrambled',sources_norm,1,subjects_list);
     results{5} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'walker','scrambled',sources_norm,1,subjects_list);
     results{6} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'centered','translating',sources_norm,1,subjects_list);
end
%==================================================================================
% group analysis atlas
results_atlas=cell(1,num_contrasts);
if do_group_analysis_atlas
     results_atlas{1} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'cwalker','cscrambled',[sources_norm '_' downsample_atlasname] ,1,subjects_list);
     results_atlas{2} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'twalker','tscrambled',[sources_norm '_' downsample_atlasname],1,subjects_list);
     results_atlas{3} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'cwalker','twalker',[sources_norm '_' downsample_atlasname],1,subjects_list);
     results_atlas{4} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'cscrambled','tscrambled',[sources_norm '_' downsample_atlasname],1,subjects_list);
     results_atlas{5} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'walker','scrambled',[sources_norm '_' downsample_atlasname],1,subjects_list);
     results_atlas{6} = brainstorm_groupstats_2cond_pairedttest(protocol_name, 'centered','translating',[sources_norm '_' downsample_atlasname],1,subjects_list);
end
%==================================================================================
% parse results
