...
epochs_path=fullfile('G:\test\moving_scrambled_walker\epochs\OCICA_250_concat_cond');
...
STUDY = std_makedesign(STUDY, ALLEEG, 1,'name','STUDY.design_4cond', 'variable1','condition','values1',{'cwalker' 'twalker' 'cscrambled' 'tscrambled'},'pairing1','on','delfiles','off','defaultdesign','off');
% possible simpler design with only the centered condtions (see literature)
STUDY = std_makedesign(STUDY, ALLEEG, 2,'name','STUDY.design_cw_cs', 'variable1','condition','values1',{'cwalker' 'cscrambled'},'pairing1','on','delfiles','off','defaultdesign','off');
