...
roi_names={'ifg','pmd','ipl','spl','l pl','r pl', 'pl','psts','eba-mt','occipital'};



% roi_list={ {'CP3','P3','CP1','P1'}};
% roi_names={'left-spl'};
...
time_windows_names={{'200 230';'300 360';'390 450';'450 550';'550 800'};... 
                    {'200 230';'300 360';'390 450';'450 550';'550 800'};...
                    {'200 230';'300 360';'390 450';'450 550';'550 800'};...
                    {'200 230';'300 360';'390 450';'450 550';'550 800'};...
                    {'200 230';'300 360';'390 450';'450 550';'550 800'};...
...
time_windows_names_short={{'N200';'P330';'N400';'P500';'N600'};... 
...
% eeblab channels path
eeglab_channels_file_name='standard-10-5-cap385.elp';
% eeglab_channels_file=fullfile(global_scripts_path, eeglab_channels_file_name);

% brainstorm channels path
brainstorm_channels_file_name='brainstorm_channel.pos';
% brainstorm_channels_file=fullfile(projects_scripts_path, brainstorm_channels_file_name);
