...
analysis_name='OCICA_250_csd';                              ... subfolder containing the current analysis type (refers to EEG device input data type)


conf_file_name='project_config_all_005.m';                      ...configuration file name

stat_analysis_suffix='all_bands-005-';
