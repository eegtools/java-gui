...
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.cfg_mkdir.parent = {'/data/projects/moving_scrambled_walker/spm_sources/6mm/OCICA_250_cleanica/stats/sloreta_free_vol/MOTIONwithinScrambled'};
...
%matlabbatch{6}.cfg_basicio.file_move.action.copyren.patrep.repl = 'spm_MOTIONwithinScrambled_sloreta_free_vol_P500';
