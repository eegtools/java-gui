...
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.cfg_mkdir.parent = {'/data/projects/moving_scrambled_walker/spm_sources/2mm/OCICA_250_cleanica/stats/wmne_loose_02_surf/MOTIONwithinScrambled'};
...
%matlabbatch{6}.cfg_basicio.file_move.action.copyren.patrep.repl = 'spm_MOTIONwithinScrambled_wmne_loose_02_surf_N400';
