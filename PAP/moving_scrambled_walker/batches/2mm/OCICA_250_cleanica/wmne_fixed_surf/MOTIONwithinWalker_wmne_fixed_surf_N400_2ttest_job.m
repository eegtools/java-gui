...
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.cfg_mkdir.parent = {'/data/projects/moving_scrambled_walker/spm_sources/2mm/OCICA_250_cleanica/stats/wmne_fixed_surf/MOTIONwithinWalker'};
...
%matlabbatch{6}.cfg_basicio.file_move.action.copyren.patrep.repl = 'spm_MOTIONwithinWalker_wmne_fixed_surf_N400';
