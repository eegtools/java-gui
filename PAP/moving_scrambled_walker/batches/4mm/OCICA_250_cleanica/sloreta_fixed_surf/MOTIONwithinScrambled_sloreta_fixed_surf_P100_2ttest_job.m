...
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.cfg_mkdir.parent = {'/data/projects/moving_scrambled_walker/spm_sources/4mm/OCICA_250_cleanica/stats/sloreta_fixed_surf/MOTIONwithinScrambled'};
